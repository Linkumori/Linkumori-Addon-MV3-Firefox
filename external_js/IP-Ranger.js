 ...
 * ---
 * 
 * A modern, fluent API for IP address validation and network operations
 * Built with binary string manipulation and state machine parsing
 */

...
function hasPopupConsentForStartup() {
    return storage[POPUP_CONSENT_STORAGE_KEY] === true;
}
...
browser.storage.onChanged.addListener((changes, areaName) => {
    if (areaName !== 'local' || !changes || !changes[POPUP_CONSENT_STORAGE_KEY]) {
        return;
    }

    const consentAccepted = changes[POPUP_CONSENT_STORAGE_KEY].newValue === true;

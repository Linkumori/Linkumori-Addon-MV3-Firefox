...
*
All files originally under LGPL (whether modified or unmodified) are distributed under GPL-3.0
without additional permissions as provided in Section 7 of the GNU General Public License.
* 
